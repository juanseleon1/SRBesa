...
import BESA.SocialRobot.BDIAgent.MotivationAgent.tasks.MantenerAtencionPwA.OpcionesAtencion;
...
public class UserConfiguration implements Believes {
    ...
    private BeliefAgent blvs;

    public UserConfiguration(BeliefAgent blvs) {
        this.blvs = blvs;
    }
